...
(function (global) {
    ...
    const EX = [
        ...
        { id:'pushup', fr:'Pompes', en:'Push-ups', sl:'Frappe de l\'Ombre', type:'strength', diff:1, stat:'STR', unit:'reps', base:10, equip:'none',
        ...
        { id:'diamond', fr:'Pompes diamant', en:'Diamond push-ups', sl:'Lame Convergente', type:'strength', diff:2, stat:'STR', unit:'reps', base:8, equip:'none',
        ...
        { id:'declpush', fr:'Pompes déclinées', en:'Decline push-ups', sl:'Assaut Aérien', type:'strength', diff:3, stat:'STR', unit:'reps', base:12, equip:'none',
        ...
        { id:'dips', fr:'Dips sur chaise', en:'Chair dips', sl:'Chute Contrôlée', type:'strength', diff:1, stat:'STR', unit:'reps', base:10, equip:'none',
        ...
        { id:'pike', fr:'Pompes piquées', en:'Pike push-ups', sl:'Pic de l\'Aiguille', type:'strength', diff:2, stat:'STR', unit:'reps', base:8, equip:'none',
        ...
        // ---- DOS / BICEPS ----
        { id:'pullup', fr:'Tractions', en:'Pull-ups', sl:'Ascension du Monarque', type:'strength', diff:3, stat:'STR', unit:'reps', base:5, equip:'bar',
        ...
        { id:'row', fr:'Rowing haltère', en:'Dumbbell row', sl:'Tir de l\'Archer', type:'strength', diff:2, stat:'STR', unit:'reps', base:12, equip:'dumbbells',
        ...
        { id:'suprow', fr:'Rowing inversé', en:'Inverted row', sl:'Rappel des Ombres', type:'strength', diff:2, stat:'STR', unit:'reps', base:10, equip:'bar',
          mFr:'Dos, biceps', mEn:'Back, biceps', goals:['gain','maintain'],
        ...
        // ---- JAMBES / FESSIERS ----
        { id:'squat', fr:'Squats', en:'Squats', sl:'Garde du Souverain', type:'strength', diff:1, stat:'END', unit:'reps', base:15, equip:'none',
        ...
        { id:'jumpsquat', fr:'Squats sautés', en:'Jump squats', sl:'Bond du Chasseur', type:'strength', diff:2, stat:'AGI', unit:'reps', base:12, equip:'none',
        ...
        { id:'lunge', fr:'Fentes', en:'Lunges', sl:'Pas de l\'Assassin', type:'strength', diff:1, stat:'END', unit:'reps', base:12, equip:'none',
          mFr:'Quadriceps, fessiers', mEn:'Quads, glutes', goals:['gain','maintain','lose'],
        ...
        { id:'bulgarian', fr:'Fentes bulgares', en:'Bulgarian split squats', sl:'Équilibre de la Faille', type:'strength', diff:3, stat:'END', unit:'reps', base:10, equip:'none',
        ...
        { id:'hipthrust', fr:'Hip thrust au sol', en:'Glute bridge', sl:'Élévation Tellurique', type:'strength', diff:1, stat:'STR', unit:'reps', base:15, equip:'none',
        ...
        { id:'calf', fr:'Mollets debout', en:'Standing calf raises', sl:'Pointe Silencieuse', type:'strength', diff:1, stat:'AGI', unit:'reps', base:20, equip:'none',
        ...
        { id:'wallsit', fr:'Chaise murale', en:'Wall sit', sl:'Mur Inébranlable', type:'strength', diff:2, stat:'END', unit:'time', base:45, equip:'none',
        ...
        // ---- CARDIO ----
        { id:'run', fr:'Course / Jogging', en:'Running / Jogging', sl:'Sprint du Loup d\'Ombre', type:'cardio', diff:1, stat:'END', unit:'time', base:20, equip:'none',
        ...
        { id:'rope', fr:'Corde à sauter', en:'Jump rope', sl:'Fil de la Tempête', type:'cardio', diff:1, stat:'AGI', unit:'time', base:10, equip:'none',
        ...
        { id:'burpee', fr:'Burpees', en:'Burpees', sl:'Réveil du Dragon', type:'cardio', diff:3, stat:'END', unit:'reps', base:10, equip:'none',
        ...
        { id:'climber', fr:'Mountain climbers', en:'Mountain climbers', sl:'Escalade du Donjon', type:'cardio', diff:2, stat:'AGI', unit:'time', base:30, equip:'none',
        ...
        { id:'jack', fr:'Jumping jacks', en:'Jumping jacks', sl:'Éclat Stellaire', type:'cardio', diff:1, stat:'AGI', unit:'time', base:40, equip:'none',
        ...
        { id:'highknees', fr:'Montées de genoux', en:'High knees', sl:'Galop Fantôme', type:'cardio', diff:1, stat:'AGI', unit:'time', base:30, equip:'none',
        ...
        { id:'hiit', fr:'Sprint fractionné (HIIT)', en:'HIIT sprints', sl:'Décharge du Monarque', type:'cardio', diff:3, stat:'AGI', unit:'time', base:15, equip:'none',
        ...
        { id:'walk', fr:'Marche active', en:'Brisk walk', sl:'Patrouille du Hunter', type:'cardio', diff:1, stat:'END', unit:'time', base:30, equip:'none',
        ...
        // ---- GAINAGE / ABDOS ----
        { id:'plank', fr:'Planche', en:'Plank', sl:'Bouclier de l\'Âme', type:'core', diff:1, stat:'VIT', unit:'time', base:30, equip:'none',
        ...
        { id:'sideplank', fr:'Planche latérale', en:'Side plank', sl:'Garde Latérale', type:'core', diff:2, stat:'VIT', unit:'time', base:25, equip:'none',
        ...
        { id:'crunch', fr:'Crunchs', en:'Crunches', sl:'Lame Abdominale', type:'core', diff:1, stat:'VIT', unit:'reps', base:20, equip:'none',
        ...
        { id:'legraise', fr:'Relevés de jambes', en:'Leg raises', sl:'Faux du Néant', type:'core', diff:2, stat:'VIT', unit:'reps', base:12, equip:'none',
        ...
        { id:'twist', fr:'Russian twists', en:'Russian twists', sl:'Tourbillon de l\'Ombre', type:'core', diff:2, stat:'VIT', unit:'reps', base:20, equip:'none',
        ...
        { id:'hollow', fr:'Hollow hold', en:'Hollow hold', sl:'Vide Absolu', type:'core', diff:3, stat:'VIT', unit:'time', base:30, equip:'none',
        ...
        // ---- MOBILITÉ / RÉCUP ----
        { id:'stretch', fr:'Étirements complets', en:'Full-body stretch', sl:'Rituel de Régénération', type:'mobility', diff:1, stat:'VIT', unit:'time', base:10, equip:'none',
        ...
        { id:'yoga', fr:'Yoga / Mobilité', en:'Yoga / Mobility', sl:'Flux de Mana', type:'mobility', diff:1, stat:'VIT', unit:'time', base:15, equip:'mat',
    ...
    function generateProtocol(p) {
        ...
        for (const wt of wanted) {
            ...
            dailyQuests.push({
                ...
                realName: pick[lang],
                slName: pick.sl,                  // accent thématique
